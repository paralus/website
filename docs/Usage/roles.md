---
title: "Roles"
description: "Creating & Managing Roles on ZTKA"
slug: /usage/roles
---

Roles are assigned to people in your organization. Access control is driven based on these roles. ZTKA comes with a set of pre defined roles. It also allows you to create new roles with the permissions you want.
...
- [Determine Roles](#determine-roles)
  ...
  - [As An Organisation Admin](#as-an-organisation-admin)
...
<img src="/img/docs/role-hierarchy.png" alt="Typical hierarchy of roles in an organization." />
...
- Select Profile from the drop-down menu
    ...
    <img src="/img/docs/role-user.png" alt="Checking your permission as an end user" />
...
- View current role assignment
    ...
    <img src="/img/docs/roles-users-list-admin.png" alt="Checking user permissions as an organization admin" />
    Checking user permissions as an organization admin

## Managing Roles

Assignment and management of roles for users in the organization can be done only by Organization admins. All the changes to roles are logged and can be found in the Audit Logs.
...
This is the preferred way to manage roles when you have a large number user that need similar roles. For example, if you have a team of developers, you can create a group called Developers, define the permissions and add users to the group. Even when you have a new developer joining the team, you would just need to add that user to this group.

You can read more about it in our Group documentation.
...
- Login to the console as an Organsation Admin
- Navigate to System -> Users

    <img src="/img/docs/roles-users-list-admin.png" alt="Listing all users" />
    Listing all users
...
- Click Assign User To Project button
    ...
    <img src="/img/docs/roles-users-new-project.png" alt="Assigning user to project" />
    Assigning user to project

- Select a project from the drop down
- Assign Role(s), click Save & Exit

    <img src="/img/docs/roles-new-user-project-final.png" alt="Assigning Roles to a User" />
...
- Login to the console as an Organisation Admin
- Navigate to System -> Roles

    <img src="/img/docs/roles-new-role-home.png" alt="Listing all the roles" />
    Listing all the roles

- Click on New Role
- Give a new for the new role & click Create

    <img src="/img/docs/roles-new-add-developer.png" alt="Adding a New Role" />
    Adding a New Role
...
- On the next screen, choose the [permissions](#permissions-list) that you want to assign to the role. Select the permissions from the left pane and add them to the right pane.
    ...
    <img src="/img/docs/roles-add-permissions.png" alt="Choosing permissions for the new role" />
