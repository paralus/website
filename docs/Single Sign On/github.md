...
<img src="/img/docs/oidc-github2.png" alt="GitHub OAuth App Details" height="75%" width="75%" />
...
<img src="/img/docs/oidc-github3.png" alt="Adding new identity provider in Paralus" height="75%" width="75%"/>
